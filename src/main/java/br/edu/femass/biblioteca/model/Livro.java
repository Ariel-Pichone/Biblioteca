...
public class Livro {
    ...
    private static Integer count = 0;   //Contador para quantidade de cópias
    ...
    //Pega a primeira cópia disponível e a torna indisponível para reserva-la para um Empréstimo
